...
<div id="navbar" >
  ...
  <img class="logo" src="{{asset('img/img/hehe.png')}}"> 
  ...
  @else
    <a class="nv" href="/home">{{ __('Home') }}</a>
  @endguest
...
<form class="modal-content animate" id="form-horizontal" method="POST" action="{{ route('login.custom') }}">
    ...
    <fieldset class="field">
      <center>
          ...
          <br>
          <center><h2><b> {{ __('iTrain User Log-in') }} </b></h2></center>
          <hr>
          <br>
              ...
              <form method="POST" action="{{ route('login.custom') }}"> 
                  ...
                  <div class="form-group row">
                    ...
                    {{-- <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Username') }}</label> --}}
                        ...
                        {{-- <p id="text" color="red">WARNING! Caps lock is ON.</p> --}}
                ...
                <br>
                  ...
                  <div class="form-group row">
                      ...
                      {{-- <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}</label> --}}
                          ...
                          {{-- <center><p id="text1" color="red"><b>WARNING! Caps lock is ON.</b></p><center> --}}
                  ...
                  <div class="form-group row mb-0">
                          ...
                          <center>
                            <input type="submit" name="submit" class="btn btn-" value="{{ __('Login') }}">
                  ...
                  <center><div class="reg">  
                    Still dont have an account?<a href="{{ route('register') }}"  style="font-family:'Play', sans-serif;">&nbsp;Click here.</a>
                    </div></center>
