...
@section('cont')
        ...
        <br>
    <h1><center>{{$user->username}} USERS DATA </h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update',$user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <select name="country" id="country" class="form-control">
                                        <option value="{{ $user->country}}">{{ $user->company}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="copmpany" type="text" class="form-control{{ $errors->has('copmpany') ? ' is-invalid' : '' }}" name="company" value="{{ $user->company}}" required>
